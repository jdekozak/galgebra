...
proto::terminal< space_time::base_c<1> >::type e_1 = {};
proto::terminal< space_time::base_c<2> >::type e_2 = {};
proto::terminal< space_time::base_c<3> >::type e_3 = {};
proto::terminal< space_time::base_c<4> >::type e_4 = {};
proto::terminal< space_time::base_c<5> >::type e_5 = {};

BOOST_AUTO_TEST_CASE( Numeric )
{
  BOOST_CHECK_EQUAL( (galgebra::power<mpl::integral_c<size_t,2>, mpl::integral_c<size_t,0> >::value), 1);
  BOOST_CHECK_EQUAL( (galgebra::power<mpl::integral_c<size_t,2>, mpl::integral_c<size_t,1> >::value), 2);
  BOOST_CHECK_EQUAL( (galgebra::power<mpl::integral_c<size_t,2>, mpl::integral_c<size_t,2> >::value), 4);
  BOOST_CHECK_EQUAL( (galgebra::power<mpl::integral_c<size_t,2>, mpl::integral_c<size_t,3> >::value), 8);
  BOOST_CHECK_EQUAL( (galgebra::power<mpl::integral_c<size_t,2>, mpl::integral_c<size_t,4> >::value), 16);
  BOOST_CHECK_EQUAL( (galgebra::power<mpl::integral_c<size_t,2>, mpl::integral_c<size_t,5> >::value), 32);
  BOOST_CHECK_EQUAL( (galgebra::power<mpl::integral_c<size_t,2>, mpl::integral_c<size_t,6> >::value), 64);
  BOOST_CHECK_EQUAL( (galgebra::power<mpl::integral_c<size_t,2>, mpl::integral_c<size_t,7> >::value), 128);
  BOOST_CHECK_EQUAL( (galgebra::power<mpl::integral_c<size_t,2>, mpl::integral_c<size_t,8> >::value), 256);

  BOOST_CHECK_EQUAL( (galgebra::power_of_2_c<1>::value), 0);
  BOOST_CHECK_EQUAL( (galgebra::power_of_2_c<2>::value), 1);
  BOOST_CHECK_EQUAL( (galgebra::power_of_2_c<4>::value), 2);
  BOOST_CHECK_EQUAL( (galgebra::power_of_2_c<8>::value), 3);
  BOOST_CHECK_EQUAL( (galgebra::power_of_2_c<16>::value), 4);
  BOOST_CHECK_EQUAL( (galgebra::power_of_2_c<32>::value), 5);
  BOOST_CHECK_EQUAL( (galgebra::power_of_2_c<64>::value), 6);
  BOOST_CHECK_EQUAL( (galgebra::power_of_2_c<128>::value), 7);
  BOOST_CHECK_EQUAL( (galgebra::power_of_2_c<256>::value), 8);
}

BOOST_AUTO_TEST_CASE( Metric )
{
  galgebra::display_metric()(space_time());
...
{
  BOOST_CHECK_EQUAL(space_time::make_blade()(e_3),space_time::blade_c<4>(1.0));
  BOOST_CHECK_EQUAL(space_time::make_blade()(proto::lit(2.5)), space_time::blade_c<0>(2.5));
}

BOOST_AUTO_TEST_CASE( Plus )
{
  auto e_1_plus_e_3 = space_time::plus()(e_1 + e_3);
  BOOST_CHECK_EQUAL( (space_time::get_blade_c<1>(e_1_plus_e_3)), 1.0 );
  BOOST_CHECK_EQUAL( (space_time::get_blade_c<4>(e_1_plus_e_3)), 1.0 );

  auto e_1_plus_e_2_plus_e_3 = space_time::plus()(e_1 + e_2 + e_3);
  ...
  auto e_1_plus_e_2_plus_e_3_plus_e_4 = space_time::plus()( (e_1 + e_2) + (e_3 + e_4) );
...
BOOST_AUTO_TEST_CASE( Multiplies )
{
  ...
  auto _3_3_mul_2_2 = space_time::multiplies()(proto::lit(3.3)*proto::lit(2.2));
  BOOST_CHECK_EQUAL((space_time::get_blade_c<0>(_3_3_mul_2_2)), 7.26 );

  auto _2_2_mul_3_3 = space_time::multiplies()(proto::lit(2.2)*proto::lit(3.3));
